...
(function() {
  'use strict';
  define(['jquery', 'underscore', 'flight/lib/component', '../utils/map_utils', "../utils/distance_conversion"], function($, _, defineComponent, map_utils, distanceConversion) {
    var listingsData;
    listingsData = function() {
      ...
      return this.queryData = function(data) {
        ...
        priceRange = map_utils.getPriceRange(this.attr.priceRangeRefinements);
