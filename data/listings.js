...
(function() {
  'use strict';
  define(['jquery', 'flight/lib/component', '../utils/map_utils', "../utils/distance_conversion"], function($, defineComponent, map_utils, distanceConversion) {
    var listingsData;
