...
(function() {
  'use strict';
  define(['underscore', 'flight/lib/component', 'lib/fusiontip/fusiontip', 'lib/accounting/accounting', 'map/utils/mobile_detection', './withTooltip'], function(_, defineComponent, fusionTip, accounting, mobileDetection, withTooltip) {
    ...
    neighborhoodsOverlay = function() {
      ...
      this.buildInfoWindow = function(event, polygonData) {
        ...
        this.setContent(infoData);
        return this.updatePosition(infoData, polygonData.hoodLayer);
      };
