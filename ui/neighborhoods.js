...
(function() {
  'use strict';
  define(['underscore', 'flight/lib/component', 'fusiontip', 'accounting', '../utils/mobile_detection', './tool_tip'], function(_, defineComponent, fusionTip, accounting, mobileDetection, ToolTip) {
