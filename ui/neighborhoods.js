...
(function() {
  'use strict';
  define(['jquery', 'underscore', 'flight/lib/component', 'fusiontip', 'accounting', '../utils/mobile_detection', './tool_tip'], function($, _, defineComponent, fusionTip, accounting, mobileDetection, ToolTip) {
