...
(function() {
  'use strict';
  define(['flight/lib/compose', 'flight/lib/component', 'marker-clusterer', '../utils/utilities', '../utils/mobile_detection'], function(compose, defineComponent, markerClusterer, Utils, mobileDetection) {
