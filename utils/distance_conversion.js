...
(function() {
  define([], function() {
    var decimalLimit, distanceParamDefined, kmRatio, meterToKilometer, metersToKilometers, metersToMiles, milesToMeters;
    ...
    return {
      convertMilesToMeters: function(miles) {
        return milesToMeters(miles).toFixed(decimalLimit);
      },
      convertMetersToKilometers: function(meters) {
        return metersToKilometers(meters).toFixed(decimalLimit);
      },
      convertMetersToMiles: function(meters) {
        return metersToMiles(meters).toFixed(decimalLimit);
      }
    };
  });
